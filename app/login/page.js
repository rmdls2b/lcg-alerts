  ...
  return (
    <div style={{ maxWidth: "400px", margin: "80px auto", textAlign: "center" }}>
      ...
      <form onSubmit={handleLogin}>
        ...
        <button type="submit" disabled={loading} style={{ width: "100%", padding: "12px", backgroundColor: "#00d4aa", color: "#000", border: "none", borderRadius: "6px", fontWeight: "bold", cursor: "pointer" }}>
