...
export default function LoginClient() {
  ...
  return (
    <div style={{ maxWidth: "400px", margin: "80px auto", textAlign: "center" }}>
      ...
      <p style={{ color: "#888", marginBottom: "24px", fontSize: "14px" }}>Connectez-vous pour accéder à vos alertes</p>
      ...
      <p style={{ color: "#666", fontSize: "13px", marginTop: "16px" }}>
        Pas encore de compte ? <a href="/" style={{ color: "#00d4aa" }}>S inscrire</a> — <a href="/mot-de-passe-oublié" style={{ color: "#666" }}>Mot de passe oublié</a>
      </p>
    </div>
  )
}
