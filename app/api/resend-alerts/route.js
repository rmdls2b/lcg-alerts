...
export async function GET(request) {
  try {
    ...
    for (const alert of pendingAlerts) {
      ...
      const emailHtml = alertEmailHtml({ shortFrom, shortTo, value: alert.amount, asset: alert.asset, explorerUrl, ackUrl, instructionsHtml, badge: "Rappel &mdash; Alerte non confirm&eacute;e", testBanner: false, pseudonymLabel })
      const subject = pseudonymLabel ? "[RAPPEL] Wallert — Signal d'urgence de " + pseudonymLabel + " toujours en attente" : "[RAPPEL] Wallert — Signal d'urgence toujours en attente"
