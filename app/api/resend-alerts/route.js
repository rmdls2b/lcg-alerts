...
export async function GET(request) {
  try {
    ...
    for (const alert of pendingAlerts) {
      ...
      const emailHtml = alertEmailHtml({ shortFrom, shortTo, value: alert.amount, asset: alert.asset, explorerUrl, ackUrl, instructionsHtml, badge: "Rappel &mdash; Alerte non confirm&eacute;e", testBanner: false })
