...
export async function POST(request) {
  try {
    ...
    for (const tx of activities) {
      ...
      const emailHtml = alertEmailHtml({ shortFrom, shortTo, value, asset, explorerUrl, ackUrl, instructionsHtml, badge: "&#9888; Signal d'urgence activ&eacute;", testBanner: false, pseudonymLabel })
      const subject = pseudonymLabel ? "Wallert — Signal d'urgence de " + pseudonymLabel + " : action immediate requise" : "Wallert — Signal d'urgence active : action immediate requise"
