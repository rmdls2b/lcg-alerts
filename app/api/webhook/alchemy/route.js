    ...
    for (const tx of activities) {
      ...
      await resend.emails.send({
        ...
        html: `<div style="font-family:Arial;max-width:600px;margin:0 auto;background:#0a0a0a;color:#e0e0e0;border:1px solid #ff4444;border-radius:12px;padding:40px;">
          <h1 style="color:#ff4444;text-align:center;">ALERTE TRANSACTION</h1>
          <p style="color:#ff8888;text-align:center;">Mouvement sortant detecte</p>
          <table style="width:100%;margin:20px 0;">
            <tr style="border-bottom:1px solid #333;"><td style="padding:10px;color:#888;">Compte</td><td style="padding:10px;text-align:right;font-weight:bold;">${watched.label || shortFrom}</td></tr>
            <tr style="border-bottom:1px solid #333;"><td style="padding:10px;color:#888;">Montant</td><td style="padding:10px;text-align:right;color:#ff4444;font-size:20px;font-weight:bold;">${value} ${asset}</td></tr>
            <tr style="border-bottom:1px solid #333;"><td style="padding:10px;color:#888;">De</td><td style="padding:10px;text-align:right;font-family:monospace;">${shortFrom}</td></tr>
            <tr style="border-bottom:1px solid #333;"><td style="padding:10px;color:#888;">Vers</td><td style="padding:10px;text-align:right;font-family:monospace;">${shortTo}</td></tr>
          </table>
          ...
          ${instructionsHtml}
          <p style="color:#666;font-size:12px;margin-top:30px;border-top:1px solid #222;padding-top:15px;">Legacy Crypto Guard - Protegez vos actifs crypto</p>
        </div>`,
      })
    }
